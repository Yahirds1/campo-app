/* =========================================================
   Registro de Campo — Tello Produce
...
document.getElementById('btnGuardarConfig').addEventListener('click', async () => {
  try {
    ...
    if (apiKey && apiKey.length < 24) throw new Error('La clave del Webhook debe tener al menos 24 caracteres.');
